...
const TopBar = () => {
  ...
  return (
    <div className={`fixed top-0 left-0 right-0 h-9 backdrop-blur-md flex items-center justify-between px-4 z-[10000] text-xs font-medium select-none border-b ${isDarkMode ? 'bg-black/60 border-white/10 text-white' : 'bg-mac-window/50 border-white/10 text-gray-800 dark:text-white'}`}>
