...
const WindowFrame = ({ windowItem, zIndex }) => {
  const { id, appId, isMinimized, isMaximized, position, size } = windowItem;
    ...
    <AnimatePresence>
      {!isMinimized && (
        ...
        >
          ...
          >
            {/* Window Header */}
            <div className={`window-header h-10 border-b flex items-center px-4 space-x-2 select-none cursor-grab active:cursor-grabbing ${
              isDarkMode
